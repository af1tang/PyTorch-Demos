...
class DCGenerator(nn.Module):
    def __init__(self, noise_size, conv_dim):
        ...
        ###########################################
        ##   Make your own Architecture here!    ##
        ###########################################
...
def training_loop(dataloader, opts):
    ...
    for epoch in range(opts.num_epochs):
        ...
        for batch in dataloader:
            ...
            real_labels, fake_labels = to_var(real_labels), to_var(fake_labels)
...
def sample_noise(dim):
    """
    Creates "z", a PyTorch Variable using uniform random noise.
    ...
    Output:
    - Noise vector of (batch_size, dim, 1, 1) ranging from (-1, 1).
    """
...
### Main ###
def main(opts):
    """Data loading, creates checkpoint and sample dirs,
     and runs training loop.
    """
    # Create the dataset
...
def create_parser():
    ...
    parser.add_argument('--dataroot', type=str, default= '/Users/af1tang/Dropbox/Work/garage/datasets/pokemon')
