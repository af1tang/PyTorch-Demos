...
class Model:
    ...
    def save(self, name):
        f = open(name, 'wb')
        state_dict = {'W1': self.model.layers[0].weight, 'W2': self.model.layers[1].weight,
                      'W3': self.model.layers[3].weight, 'b1': self.model.layers[1].bias,
                      'b2': self.model.layers[3].bias, 'vocab': self.vocab}
